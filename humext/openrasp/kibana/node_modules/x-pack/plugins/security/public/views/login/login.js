...
chrome_1.default
    ...
    .setRootController('login', ($scope, $http, $window, secureCookies, loginState, loginAssistanceMessage) => {
    ...
    $scope.$$postDigest(() => {
        ...
        react_dom_1.render(react_1.default.createElement(i18n_2.I18nContext, null,
            react_1.default.createElement(components_1.LoginPage, { http: $http, window: $window, infoMessage: lodash_1.get(messageMap, msgQueryParam), loginState: loginState, isSecureConnection: isSecure, requiresSecureConnection: secureCookies, loginAssistanceMessage: loginAssistanceMessage, next: next })), domNode);
    });
});
