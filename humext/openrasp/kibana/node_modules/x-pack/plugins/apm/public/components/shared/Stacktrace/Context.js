...
const javascript_1 = tslib_1.__importDefault(require("react-syntax-highlighter/dist/cjs/languages/hljs/javascript"));
const python_1 = tslib_1.__importDefault(require("react-syntax-highlighter/dist/cjs/languages/hljs/python"));
const ruby_1 = tslib_1.__importDefault(require("react-syntax-highlighter/dist/cjs/languages/hljs/ruby"));
...
react_syntax_highlighter_1.Light.registerLanguage('javascript', javascript_1.default);
react_syntax_highlighter_1.Light.registerLanguage('python', python_1.default);
react_syntax_highlighter_1.Light.registerLanguage('ruby', ruby_1.default);
...
function Context({ stackframe, codeLanguage, isLibraryFrame }) {
    ...
    return (react_1.default.createElement(ContextContainer, null,
        ...
        react_1.default.createElement(LineNumberContainer, { isLibraryFrame: isLibraryFrame }, lines.map((line, i) => (react_1.default.createElement(LineNumber, { key: line + i, highlight: highlightedLineIndex === i },
            i + startLineNumber,
            ".")))),
        react_1.default.createElement(LineContainer, null, lines.map((line, i) => (react_1.default.createElement(react_syntax_highlighter_1.Light, { key: line + i, language: language, style: hljs_1.xcode, PreTag: Line, CodeTag: Code, customStyle: { padding: null, overflowX: null } }, line || '\n'))))));
}
