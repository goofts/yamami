...
async function fetchUpgradeAssistantMetrics(callCluster, server) {
    ...
    const getTelemetrySavedObject = (upgradeAssistantTelemetrySavedObjectAttrs) => {
        ...
        return {
            ui_open: {
                overview: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_open.overview', 0),
                cluster: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_open.cluster', 0),
                indices: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_open.indices', 0),
            },
            ui_reindex: {
                close: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_reindex.close', 0),
                open: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_reindex.open', 0),
                start: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_reindex.start', 0),
                stop: lodash_1.get(upgradeAssistantTelemetrySavedObjectAttrs, 'ui_reindex.stop', 0),
            },
        };
    };
    return {
