...
:callcommand
if [%_COMMAND%]==[console] (
    %_WRAPPER_EXE% -c "%_WRAPPER_CONF%" wrapper.logfile.loglevel=NONE wrapper.console.title="OneDev Reset Admin Password" wrapper.name=onedev_reset-admin-password wrapper.displayname="OneDev Reset Admin Password" wrapper.description="OneDev Reset Admin Password" -- reset-admin-password %_PARAMETERS%
