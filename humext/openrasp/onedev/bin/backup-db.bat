...
:callcommand
if [%_COMMAND%]==[console] (
    %_WRAPPER_EXE% -c "%_WRAPPER_CONF%" wrapper.logfile.loglevel=NONE wrapper.console.title="OneDev Backup Database" wrapper.name=onedev_backup-db wrapper.displayname="OneDev Backup Database" wrapper.description="OneDev Backup Database" -- backup-db %_PARAMETERS%
