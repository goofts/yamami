...
#       Configuration GUI.
### BEGIN INIT INFO
# Provides: onedev_reset-admin-password
...
# Default-Stop: 0 1 6
# Short-Description: OneDev Reset Admin Password
# Description: OneDev Reset Admin Password
### END INIT INFO
...
APP_NAME="onedev_reset-admin-password"
APP_LONG_NAME="OneDev Reset Admin Password"
...
prepAdditionalParams() {
    ...
    if [ "X${PASS_THROUGH}" = "Xapp_args" -o "X${PASS_THROUGH}" = "Xboth" ] ; then
        if [ "X${PASS_THROUGH}" = "Xapp_args" ] ; then
            ADDITIONAL_PARA="wrapper.logfile.loglevel=NONE wrapper.console.title='OneDev Reset Admin Password' wrapper.description='OneDev reset-admin-password' -- reset-admin-password"
