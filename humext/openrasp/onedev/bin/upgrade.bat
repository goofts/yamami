...
:callcommand
if [%_COMMAND%]==[console] (
    %_WRAPPER_EXE% -c "%_WRAPPER_CONF%" wrapper.logfile.loglevel=NONE wrapper.console.title="OneDev Upgrade" wrapper.name=onedev_upgrade wrapper.displayname="OneDev Upgrade" wrapper.description="OneDev Upgrade" -- upgrade %_PARAMETERS%
