...
:callcommand
if [%_COMMAND%]==[console] (
    %_WRAPPER_EXE% -c "%_WRAPPER_CONF%" wrapper.logfile.loglevel=NONE wrapper.console.title="OneDev Apply DB Constraints" wrapper.name=onedev_apply-db-constraints wrapper.displayname="OneDev Apply DB Constraints" wrapper.description="OneDev Apply DB Constraints" -- apply-db-constraints %_PARAMETERS%
